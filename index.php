...
<div class="bottom-section">
    <div class="photo-container">
        <img src="image 41.png" alt="Enhancing Beauty" class="photo">
...
<div class="services-photos">
    <div class="service-photo">
        <img src="hair.png" alt="Hair Removal">
        <button class="btn view-button" style="background-color: #E1AC41;">View</button>
    </div>
    <div class="service-photo">
        <img src="body.png" alt="Body Treatments">
        <button class="btn view-button" style="background-color: #E1AC41;">View</button>
    </div>
</div>
...
<div id="about" class="about-us-section">
    <div class="about-us-content">
        <div class="about-us-content-left">
            <img src="emplo.png" alt="Employee" class="employee-pic">
        </div>
...
<div id="reasons-section">
    ...
    <div id="frame-photo">
        <img src="Big.png" alt="Frame Photo" id="inner-photo">
    </div>
</div>
